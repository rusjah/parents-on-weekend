...
function AboutMe({setnewUser, workState}) {
  return (
        ...
        <div className='flex flex-col gap-4 border-orange-100 border-2 p-4 w-[100%]'>
            ...
            <textarea onChange={(e) => setnewUser(i => ({...i, aboutMe: e.target.value}))}  name='aboutMe' className="textarea textarea-warning w-full h-full " placeholder="About me"></textarea>
            </label>
        </div>
