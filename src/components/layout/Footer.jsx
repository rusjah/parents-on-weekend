...
// add link to links for section
function Footer() {
  return (
    <footer className="footer p-10 bg-[#D4A373] text-lime-950 font-bold h-[26vh]">
        <aside>
            ...
            <p className='text-yellow-950'>GrandParents on weekend<br/>Let's make this world better together</p>
        </aside> 
        <nav>
        ...
        <nav>
            ...
            <a className="link link-hover">Change world together</a>
        </nav> 
    </footer>
  )
}
